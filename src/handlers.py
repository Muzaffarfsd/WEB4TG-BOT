...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    voice_greeting = f"""Привет{name_part}! Лучшее доказательство того, что моя система работает — это то, что ты сейчас слушаешь это сообщение.

Тебя привлекло моё приложение, а удержал мой ИИ-агент. Это идеальная связка: визуал плюс интеллект.

Я внедрил это себе и забыл про рутину. Если хочешь так же — просто нажми кнопку. Сделаем копию моей системы для твоего бизнеса."""
