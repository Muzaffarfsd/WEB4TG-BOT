...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    voice_greeting = f"""Привет{name_part}! Знаешь... лучшее доказательство того, что моя система работает — это то, что ты сейчас слушаешь это сообщение.

Смотри: тебя привлекло моё приложение, а удержал — мой ИИ-агент. Вот эта связка — визуал плюс интеллект — она реально работает.

Я внедрил это себе и, честно, забыл про рутину. Хочешь так же? Просто нажми кнопку — сделаем копию моей системы для твоего бизнеса."""
