...
OBJECTION_STRATEGIES = {
    "price": "СТРАТЕГИЯ_ЦЕНА: НЕ снижай цену! Используй модель трёх мозгов:\n• Рептильный: \"Договор, гарантия возврата предоплаты, 14 дней правок — вы ничем не рискуете\"\n• Эмоциональный: Визуализируй результат (\"Представьте: клиенты заказывают в 2 клика, 24/7\")\n• Рациональный: Покажи ROI (\"Один дополнительный заказ в день по 2000₽ = 60 000₽/мес. Приложение окупается за 2-3 месяца\")\nЯкорь: Сначала назови полный пакет, потом предложи MVP. Упомяни рассрочку и систему скидок за монеты.",
    "delay": "СТРАТЕГИЯ_ОТЛОЖИТЬ: Используй нейро-подход к срочности:\n• Рептильный: Мягкая потеря (\"Каждый день без приложения — это X потерянных клиентов\")\n• Эмоциональный: Контраст будущего (\"Через 10 дней у вас уже работающее приложение\")\n• Рациональный: Факт (\"Команда сейчас свободна, через 2 недели — очередь до месяца\")\nМикро-обязательство: Предложи бесплатный шаг — расчёт стоимости или ТЗ.",
    "competitor": "СТРАТЕГИЯ_КОНКУРЕНТ: Не критикуй! Задавай уточняющие вопросы (\"Что именно предлагают?\"). Подчеркни уникальность:\n• Специализация только на Telegram Mini Apps (не на всём подряд)\n• 7-15 дней (не месяцы)\n• Apple-дизайн, нет комиссий маркетплейсов (экономия 15-25%)\n• Договор + гарантия + этапная оплата\nСоциальное доказательство: Назови конкретные кейсы (Radiance, TimeElite, GlowSpa).",
    "doubt": "СТРАТЕГИЯ_СОМНЕНИЕ: Используй визуализацию + социальное доказательство:\n• \"Один наш клиент из [похожая ниша] тоже сомневался. Через месяц его выручка выросла на 40%\"\n• Предложи бесплатную консультацию (schedule_consultation)\n• Упомяни гарантию возврата предоплаты\n• Покажи портфолио (show_portfolio)\nМикро-обязательство: \"Давайте просто посчитаем стоимость — ни к чему не обязывает\"",
    "trust": "СТРАТЕГИЯ_ДОВЕРИЕ: Максимальная открытость:\n• Покажи портфолио реальных проектов (show_portfolio)\n• Упомяни договор (/contract)\n• Этапная оплата (35%+65%) — \"Платите большую часть только когда увидите готовый результат\"\n• 14 дней правок после сдачи\n• Предложи посмотреть демо-версии проектов",
    "free": "СТРАТЕГИЯ_БЕСПЛАТНОЕ: Не обесценивай запрос! Покажи разницу:\n• \"Конструкторы (Tilda, Wix) не работают внутри Telegram — клиенту нужно переходить на сайт, это теряет 70% конверсии\"\n• \"Бесплатное решение = ваше время + ограниченный функционал + без поддержки\"\n• \"Mini App в Telegram — это не сайт, это нативное приложение внутри мессенджера\"\nПредложи MVP как доступный вход: шаблон магазина от 150к с рассрочкой (предоплата 52 500₽).",
    "diy": "СТРАТЕГИЯ_САМИ: Уважай решение, но покажи реальность:\n• \"Разработка Mini App силами одного разработчика — 2-4 месяца. У нас — 7-15 дней\"\n• \"No-code платформы не поддерживают Telegram Mini Apps API нативно\"\n• \"Стоимость штатного разработчика: 150-250к/мес. Наш проект — разовая инвестиция\"\nValue-first: Предложи бесплатно составить ТЗ — \"Пригодится в любом случае\"",
    "timing": "СТРАТЕГИЯ_ВРЕМЯ: Покажи стоимость ожидания:\n• \"Каждый месяц без приложения — это X упущенных клиентов, которые покупают у конкурентов\"\n• \"Лучшее время — когда бизнес растёт, а не когда уже отстали\"\n• \"Разработка 7-15 дней — к [дата через 2 недели] у вас уже работающее приложение\"\nМикро-обязательство: \"Давайте сейчас просто обсудим идею — ни к чему не обязывает\""
}
...
SOCIAL_PROOF_TRIGGERS = {
    "doubt": [
        "Один наш клиент из сферы услуг за первый месяц после запуска получил 47 новых заказов через Mini App — при среднем чеке 3 500₽ это +164 000₽ выручки.",
        "Radiance (магазин одежды) — запустили за 10 дней, в первую неделю 200+ заказов. Владелец сказал: \"Жалею, что не сделал раньше\".",
        "У 87% наших клиентов приложение окупается в первые 2-3 месяца — мы специально считаем ROI перед стартом."
    ],
    "competitor": [
        "Наше отличие: мы специализируемся только на Telegram Mini Apps. Не делаем сайты, не делаем мобильные приложения — только Telegram. Поэтому делаем за 7-15 дней то, что другие делают за 2-3 месяца.",
        "В отличие от маркетплейсов (WB, Ozon), в Telegram Mini App нет комиссий 15-25%. Вся выручка — ваша.",
        "Фрилансер предложит дешевле, но: нет договора, нет гарантии, нет поддержки, сроки плывут. У нас — договор, 35%+65% оплата, 14 дней правок."
    ],
    "trust": [
        "У нас более 20 завершённых проектов: Radiance, TimeElite, GlowSpa, DeluxeDine. Все можно посмотреть в портфолио.",
        "Работаем по договору. Предоплата 35% — дизайн и прототип. Остальные 65% — только когда вы одобрите готовый результат.",
        "14 дней бесплатных правок после сдачи. Если результат не устроит — вернём предоплату."
    ],
    "price": [
        "Для сравнения: штатный разработчик стоит 150-250к/мес и работает 2-4 месяца. Наш проект — разовая инвестиция от 150к и результат через 7-15 дней.",
        "Средний ROI наших клиентов — 300% за первый год. При среднем чеке 2000₽ и 3 доп. заказах в день приложение за 150к окупается за 25 дней.",
        "Рассрочка: предоплата всего 52 500₽ (35%) за магазин. Остальное — когда увидите готовый результат."
    ]
}
...
INDUSTRY_CASE_STUDIES = {
    ...
    "medical": {
        "name": "MedLine",
        "desc": "многопрофильная клиника",
        "result": "заполняемость слотов выросла на 30%, no-show снизился на 50%",
        "quote": "Пациенты записываются сами через Telegram — администраторы наконец свободны"
    },
    "services": {
        "name": "CleanPro",
        "desc": "клининговый сервис",
        "result": "конверсия из заявки в заказ выросла на 40%, повторные заказы +25%",
        "quote": "Клиенты заказывают уборку в два клика, без звонков"
    },
    "education": {
        "name": "SkillUp",
        "desc": "онлайн-школа",
        "result": "доходимость до конца курса выросла на 55%, средний чек вырос на 20%",
        "quote": "Ученики не забывают про занятия — напоминания прямо в Telegram"
    },
}
